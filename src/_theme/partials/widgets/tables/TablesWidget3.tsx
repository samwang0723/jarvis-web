...
export const TablesWidget3: FC<Props> = ({ className }) => {
    ...
    return (
        <div
            ...
            data-select2-id="select2-data-174-lp3l"
        >
            {/* begin::Card header */}
            <div className="card-header py-7">
                ...
                <div className="card-title pt-3 mb-0 gap-4 gap-lg-10 gap-xl-15 nav nav-tabs border-bottom-0">
                    {/* begin::Tab item */}
                    <div
                        className={`fs-4 fw-bolder pb-3 cursor-pointer ${tabNumber === 1
                    ...
                    {/* begin::Tab item */}
                    <div
                        className={`fs-4 fw-bolder pb-3 cursor-pointer ${tabNumber === 2
                                ? "border-bottom border-3 border-primary"
                                : "text-muted"
                            }`}
                        onClick={() => {
                    ...
                    {/* begin::Tab item */}
                    <div
                        className={`fs-4 fw-bolder pb-3 cursor-pointer ${tabNumber === 3
                                ? "border-bottom border-3 border-primary"
                                : "text-muted"
                            }`}
                        onClick={() => {
            ...
            <div className="card-body pt-1" data-select2-id="select2-data-173-atm3">
                {/* begin::Sort & Filter */}
                <div
                    className="d-flex flex-stack flex-wrap gap-4"
                    data-select2-id="select2-data-172-n2uq"
                >
                    {/* begin::Sort */}
                    <div
                                            ...
                                            <td>
                                                ...
                                                <div className="d-flex gap-2 mb-2">
                                                    <a href="#" className="symbol symbol-20px">
                                                        <img
                                                            src={toAbsoluteUrl(
                                                                "/media/svg/brand-logos/facebook-4.svg",
                                                            )}
                                                            alt=""
                                                        />
                                                    </a>
                                                    <a href="#" className="symbol symbol-20px">
                                                        <img
                                                            src={toAbsoluteUrl(
                                                                "/media/svg/brand-logos/twitter-2.svg",
                                                            )}
                                                            alt=""
                                                        />
                                                    </a>
                                                    <a href="#" className="symbol symbol-20px">
                                                        <img
                                                            src={toAbsoluteUrl(
                                                                "/media/svg/brand-logos/instagram-2-1.svg",
                                                            )}
                                                            alt=""
                                                        />
                                                    </a>
                                                    <a href="#" className="symbol symbol-20px">
                                                        <img
                                                            src={toAbsoluteUrl(
                                                                "/media/svg/brand-logos/linkedin-2.svg",
                                                            )}
                                                            alt=""
                                                        />
                                                    </a>
                                                    <a href="#" className="symbol symbol-20px">
                                                        <img
                                                            src={toAbsoluteUrl(
                                                                "/media/svg/brand-logos/youtube-3.svg",
                                                            )}
                                                            alt=""
                                                        />
                                                    </a>
                                        ...
                                        <tr className="odd">
                                            ...
                                            <td className="min-w-125px">
                                                ...
                                                <div className="symbol-group symbol-hover mb-1">
                                                    ...
                                                    <div className="symbol symbol-circle symbol-25px">
                                                        <img
                                                            src={toAbsoluteUrl("/media/avatars/300-13.jpg")}
                                                            alt=""
                                                        />
                                                    </div>
                                                    {/* end::Member */}
