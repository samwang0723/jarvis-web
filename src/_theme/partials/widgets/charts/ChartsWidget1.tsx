...
export const ChartsWidget1: FC<Props> = ({
    className,
    chartHeight,
    chartColor,
}) => {
...
const chartOptions = (
    ...
    const negativeColor = chartColor
        ? chartColor
        ...
        series: [
            {
                name: "Net Profit",
                data: [
                    20, 30, 20, 40, 60, 75, 65, 18, 10, 5, 15, 40, 60, 18, 35, 55, 20,
                ],
            },
            {
                name: "Revenue",
                data: [
                    -20, -15, -5, -20, -30, -15, -10, -8, -5, -5, -10, -25, -15, -5, -10,
                    -5, -15,
                ],
            },
        ],
